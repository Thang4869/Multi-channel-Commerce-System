        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl bg-white/80 p-4">
              <p className="text-sm text-muted">Cushioning</p>
              <p className="text-lg font-semibold">Responsive foam</p>
            </div>
            <div className="rounded-2xl bg-white/80 p-4">
              <p className="text-sm text-muted">Upper</p>
              <p className="text-lg font-semibold">Engineered knit</p>
            </div>
          </div>
        </div>
      </div>
